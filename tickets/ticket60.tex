...
\end{conj}
\notice \; Ограниченный оператор и ограниченное отображение -- это не одно и то же. Более того, линейность + ограниченное отображение = тождественный 0. Пусть это не так и $\mathcal{A}x \neq 0$. Тогда:
\begin{gather*}
  \norm{\mathcal{A}x} \neq 0 \implies \norm{\mathcal{A}(\lambda x)} = | \lambda | \norm{\mathcal{A}x} \underset{\lambda \to \infty}{\longrightarrow} \infty
\end{gather*}
Получили противоречие. Значит не существует линейных ограниченных отображений, помимо тривиального.
